...
impl LayoutThread {
    ...
    fn new(
        ...
        let viewport_size = window_size.initial_viewport.unwrap_or_default();
        ...
        LayoutThread {
            ...
            viewport_size: Size2D::new(
                Au::from_f32_px(viewport_size.width),
                Au::from_f32_px(viewport_size.height),
            ),
            compositor_api,
    ...
    fn handle_viewport_change(
        ...
        let viewport = window_size_data.initial_viewport.unwrap_or_default();
