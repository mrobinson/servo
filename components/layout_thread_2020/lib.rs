...
impl LayoutThread {
    ...
    fn new(
        ...
        let device = Device::new(
            MediaType::screen(),
            QuirksMode::NoQuirks,
            window_size.initial_viewport.unwrap_or_default(),
        ...
        let initial_viewport = window_size.initial_viewport.unwrap_or_default();
        LayoutThread {
            id,
            url,
            is_iframe,
    ...
    fn viewport_did_change(&mut self, window_size_data: WindowSizeData) -> bool {
        ...
        let initial_viewport = window_size_data.initial_viewport.unwrap_or_default();
    ...
    fn update_device(
        ...
        let viewport_size = window_size_data.initial_viewport.unwrap_or_default();
        let device = Device::new(
            MediaType::screen(),
