...
impl ScriptThread {
    ...
    fn handle_event(&self, pipeline_id: PipelineId, event: CompositorEvent) {
        match event {
            ...
            TouchEvent(event_type, identifier, point, node_address) => {
                let touch_result = self.handle_touch_event(pipeline_id,
                                                           event_type,
                                                           identifier,
                                                           point,
                                                           node_address);
            ...
            TouchpadPressureEvent(_point, pressure, phase, node_address) => {
                ...
                doc.handle_touchpad_pressure_event(self.js_runtime.rt(),
                                                   pressure,
                                                   phase,
                                                   node_address);
            }
    ...
    fn handle_mouse_event(&self,
        ...
        document.handle_mouse_event(self.js_runtime.rt(),
                                    button,
                                    point,
                                    mouse_event_type,
                                    node_address);
    ...
    fn handle_touch_event(&self,
        ...
        document.handle_touch_event(self.js_runtime.rt(),
                                    event_type,
                                    identifier,
                                    point,
                                    node_address)
