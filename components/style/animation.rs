            ...
            .map(|step| match step.value {
                ...
                KeyframesStepValue::Declarations {
                    ...
                    let timing_function = if step.declared_timing_function {
                        Some(computed_style.get_box().animation_timing_function_at(0))
                    } else {
                        None
                    };
...
pub struct Animation {
    ...
    /// The default timing function to use for this animation.
...
impl Animation {
    ...
    fn update_style(&self, context: &SharedStyleContext, style: &mut Arc<ComputedValues>) {
        ...
        let timing_function = prev_keyframe
            .timing_function
            .unwrap_or(self.default_timing_function);
    ...
    E: TElement,
{
    ...
    for (i, name) in box_style.animation_name_iter().enumerate() {
        ...
        let new_animation = Animation {
            ...
            computed_steps,
            default_timing_function: new_style.get_box().animation_timing_function_mod(i),
